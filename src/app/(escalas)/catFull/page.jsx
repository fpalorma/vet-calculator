...
export default function Page() {
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    setScore(totalScore);
    const r2 = 0.213 * totalScore - 9.472;
      ...
      <form onSubmit={onSubmit}>
        <div className=" mx-auto w-fit mb-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value={7}>Can stand only when assisted, responsive but dull</option>
              <option value={8}>Unabled to stand, responsive</option>
              <option value={9}>Unabled to stand, unresponsive</option>
            </select>
        ...
        <div className="mt-8">
          ...
          >
            ...
            {isModal && (
              <Modal
                titulo="Escala Apple full para gato"
